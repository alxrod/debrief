...
export const WindowMonitorContext = createContext()

const WindowMonitor = (props) => {
  ...
  return (
    <WindowMonitorContext.Provider value={windowIsActive}>
      {props.children}
    </WindowMonitorContext.Provider>
  )
}
