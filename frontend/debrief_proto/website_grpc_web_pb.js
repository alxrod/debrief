 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.communication.NullRequest,
 *   !proto.communication.NullResponse>}
 */
const methodDescriptor_Generate_TestConn = new grpc.web.MethodDescriptor(
  '/communication.Generate/TestConn',
  grpc.web.MethodType.UNARY,
  debrief_proto_generic_pb.NullRequest,
  debrief_proto_generic_pb.NullResponse,
  /**
   * @param {!proto.communication.NullRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.communication.NullRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.communication.NullResponse)}
 ...
 *     The XHR Node Readable Stream
 */
proto.communication.GenerateClient.prototype.testConn =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/communication.Generate/TestConn',
      request,
      metadata || {},
      methodDescriptor_Generate_TestConn,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.communication.GeneratePromiseClient.prototype.testConn =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/communication.Generate/TestConn',
      request,
