// source: debrief_proto/generic.proto
/**
 * @fileoverview
 * @enhanceable
...
goog.exportSymbol('proto.communication.NullRequest', null, global);
 ...
 * @constructor
 */
proto.communication.NullRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.communication.NullRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.communication.NullRequest.displayName = 'proto.communication.NullRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.communication.NullRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.communication.NullRequest.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.communication.NullRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.communication.NullRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.communication.NullRequest}
 */
proto.communication.NullRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.communication.NullRequest;
  return proto.communication.NullRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.communication.NullRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.communication.NullRequest}
 */
proto.communication.NullRequest.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.communication.NullRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.communication.NullRequest.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.communication.NullRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.communication.NullRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
